...
handleBuyToken = async () => {
  await this.myTokenSale.methods.buyTokens(this.accounts[0]).send({from: this.accounts[0], value: 25});
}
...
listenToTokenTransfer = async() => {
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>Shaler Token </h1>
        <p>Lets take a trip back to 2003 English</p>
